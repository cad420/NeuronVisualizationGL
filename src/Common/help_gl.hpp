...
#define GL_EXPR(exec)                                                                                                  \
    {                                                                                                                  \
        ...
        {                                                                                                              \
            spdlog::error("OpenGL error:{0:x} caused by {1} on line {2} of file:{3}",                                  \
                          static_cast<unsigned int>(gl_err), #exec, __LINE__, __FILE__);                               \
        }                                                                                                              \
    };
...
#define GL_CHECK                                                                                                       \
    {                                                                                                                  \
        ...
        if ((gl_err = glGetError()) != GL_NO_ERROR)                                                                    \
        {                                                                                                              \
            spdlog::error("OpenGL error: {0} caused before  on line {1} of file:{2}",                                  \
